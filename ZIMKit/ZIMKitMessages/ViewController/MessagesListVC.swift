...
open class MessagesListVC: _ViewController {
    ...
    func setupNav() {
        let name = conversationName.count > 0 ? conversationName : conversationID
    ...
    func loadConversationInfo() {
        if conversationType == .peer {
            ...
            viewModel.queryGroupInfo { [weak self] info, _ in
...
extension MessagesListVC {
    ...
    func sendImageMessage(with url: URL) {
        ...
        let filePrefix = ZIMKit.imagePath + generateFileName()
        var filePath = ""
    ...
    func sendVideoMessage(with url: URL) {
        ...
        let filePrefix = ZIMKit.videoPath + generateFileName()
    ...
    func sendFileMessage(with url: URL) {
        ...
        var filePath = ZIMKit.filePath + fileName
        ...
        if FileManager.default.fileExists(atPath: filePath) {
            ...
            while FileManager.default.fileExists(atPath: filePath) {
                ...
                filePath = ZIMKit.filePath + newFileName
            }
        }
